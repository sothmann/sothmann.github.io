...
Besides that, developers who are used to work with statically typed languages and strong tooling on the back end,
...
- [GWT](http://www.gwtproject.org/)  
  ...
  the programming language,   so you benefit from the outstanding tooling for Java. GWT sees JavaScript as ByteCode,
...
But Microsoft has changed a lot in the last years - especially since Satya Nadella become the CEO and has dramatically
...
browser. But the browser is required to support source maps.
